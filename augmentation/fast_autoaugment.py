...
from augmentation.archive import arsaug_policy, autoaug_policy, autoaug_paper_cifar10, fa_reduced_cifar10, fa_reduced_svhn, fa_resnet50_rimagenet
from augmentation.fa_augmentations import *
...
def get_transform(dataset):
    ...
    if dataset == 'cifar10' or dataset == 'cifar100':
        transform_train.transforms.insert(1, Augmentation(fa_reduced_cifar10()))
    elif dataset == 'tiny-imagenet':
        transform_train.transforms.insert(1, Augmentation(fa_resnet50_rimagenet()))
    # total_aug = augs = None
